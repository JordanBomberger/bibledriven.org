...
This author does not believe smoking is a good idea. However, by itself, there is nothing sinful about it. But the believer should consider the following below. 
...
## T**here are multiple ways to worship and musical praise is but one of those options**
...
**11**. Dancing (along with the music that goes with it) is another area of Christian liberty that believers need to handle with care. This activity is harmless unless it becomes an inappropriate ritual (the music one dances to also needs to be considered). This is another perfectly fine activity. 
